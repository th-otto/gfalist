...
const char *const gfalct[] = {
	 ...
	 */
	/* 639 */ "SUPER ",
	/* 640 */ "PIXEL24 ", /* 5 arguments */
	/* 641 */ "PIXEL24 ", /* 7 arguments */
	/* 642 */ "PIXEL32 ", /* 5 arguments */
	/* 643 */ "PIXEL32 ", /* 7 arguments */
	/* 644 */ "PIXEL16 ", /* 5 arguments */
	/* 645 */ "PIXEL16 ", /* 7 arguments */
	/* 646 */ "PIXEL15 ", /* 5 arguments */
	/* 647 */ "PIXEL15 ", /* 7 arguments */
	/* 648 */ "BAR ",
	/* 649 */ "PBAR ",
	/* 650 */ "RBAR ",
	/* 651 */ "PRBAR ",
	...
	/* 674 */ "USERDEF%(",
	/* 675 */ "CRASTER ",
	/* 676 */ "RC_REDRAW", /* no arguments */
	/* 677 */ "RC_REDRAW", /* 4 arguments */
	/* 678 */ NULL,
	/* 679 */ NULL,
	/* 680 */ "ARRAY!(",
	/* 681 */ "ARRAY|(",
...
/* Secondary function text */
const char *const gfasft_212[256] = {
	/*    0 */ "GETMPB(",
	/*    1 */ "MADDALT(",
	/*    2 */ "MFPINT(",
	/*    3 */ "XBTIMER(",
