...
static struct argdesc const x1480d[] = {
	...
	{ ARG_POP_ },
	{ ARG_INSERT, { (void *)TOK_GOSUB_FUNC } },
	{ ARG_END_ }
};
...
static struct argdesc const ySUB_args[] = {
	...
	{ ARG_INSERT, { (void *)TOK_CMD_PROCEDURE } },
