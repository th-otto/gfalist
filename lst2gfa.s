...
decimal_digits:     ds.w 1         /*  542 */
                    ds.b 306
input_buffer:       ds.b 256       /*  850 */
general_buffer:     ds.b 256       /* 1106 */
token_buffer_len:   ds.w 1         /* 1362 */
token_buffer:       ds.b 478       /* 1364 */
o1842:              ds.b 472       /* 1842 */
o2314:              ds.b 458       /* 2314 */
...
input_buffer:       ds.b 182       /*  324 */
o2314:              ds.b 74        /*  506 */
general_buffer:     ds.b 256       /*  580 */
token_buffer_len:   ds.w 1         /*  836 */
token_buffer:       ds.b 126       /*  838 */
o2772:              ds.b 214       /*  964 */
...
x1160e:
		...
		move.w     d0,8434(a6)
x1160e_1:
		lea.l      input_buffer(a6),a1
		bsr        x1181c
		move.b     input_buffer(a6),d0
		cmpi.b     #CR,d0
		beq.s      x1160e_1
		cmpi.b     #NL,d0
		beq.s      x1160e_1
...
x1160e_10:
		...
		move.b     d0,1(a0)
		addq.l     #1,x10302
		cmpi.b     #'>',input_buffer(a6)
		bne.s      x1160e_12
		move.b     #' ',input_buffer(a6)
		jsr        x137d2.l
...
x137d2_4:
		...
		bhi.s      x137d2_6
		move.w     d0,(a1)
		asl.w      2(a1) /* token value now index * 4 */
		rts
x13886:
		movea.l    save_sp(pc),a7
		suba.l     a1,a1
x137d2_5:
...
handle_function_1:
		...
		cmpi.b     #TOK_LINE_COMMENT,d0 /* bug: should be cmpi.w */
...
f13b6c_4:
		...
		rts
f13b6c_5:
		addq.w     #(TOK_CMD_DO_UNTIL-TOK_CMD_DO_WHILE)*2,token_buffer(a6) /* DO WHILE -> DO UNTIL */
		addq.l     #1,a0
		cmpi.b     #'N',(a0)+
		bne.s      f13b6c_4
		cmpi.b     #'T',(a0)+
...
f13bca:
		...
		addq.l     #1,a0
f13bca_1:
		lea.l      (input_buffer-general_buffer)(a0),a3
f13bca_2:
		move.b     (a3)+,(a1)+
		cmpi.b     #EOL,-1(a3)
		bne.s      f13bca_2
...
f13d6a:
		move.w     #TOK_CMD_FILESELECT*2,token_buffer(a6)
		lea.l      cmd_fileselect(pc),a2
		bra.s      f13da6_1
f13d76:
		move.w     #TOK_CMD_FILES*2,token_buffer(a6)
		lea.l      cmd_files(pc),a2
		bra.s      f13da6_1
f13d82:
		move.w     #TOK_CMD_DOUBLE_REF*2,token_buffer(a6)
		lea.l      cmd_double_ref(pc),a2
		bra.s      f13da6_1
f13d8e:
		move.w     #TOK_CMD_ADDRIN*2,token_buffer(a6)
		lea.l      cmd_addrin(pc),a2
		bra.s      f13da6_1
f13d9a:
		move.w     #TOK_CMD_ADDROUT*2,token_buffer(a6)
		lea.l      cmd_addrout(pc),a2
		bra.s      f13da6_1
f13da6:
		move.w     #TOK_CMD_CONTRL*2,token_buffer(a6)
...
yLINE_args:
		.dc.b ARG_BACK
		.dc.b ARG_INSERT,(TOK_CMD_LINE_INPUT*2)&255
		.dc.b ARG_PUSH,((x14213-jmpbase)>>8)&255,(x14213-jmpbase)&255
		.dc.b ARG_PUSH,((print_channel_args-jmpbase)>>8)&255,(print_channel_args-jmpbase)&255
		.dc.b ARG_PUSH,((x143ec-jmpbase)>>8)&255,(x143ec-jmpbase)&255
		.dc.b ARG_PUSH,((x1442e-jmpbase)>>8)&255,(x1442e-jmpbase)&255
		...
		.dc.b ARG_POP
		.dc.b ARG_BACK
		.dc.b ARG_INSERT,(TOK_CMD_LINE*2)&255
...
yON_args:
		...
		.dc.b ARG_INSERT,(TOK_CMD_ON_ERROR*2)&255
		.dc.b TOK_ERROR
		.dc.b ARG_BACK
		.dc.b TOK_LINE_COMMENT
...
x15060:
		.dc.b TOK_MIN
		.dc.b ARG_REPLACE,TOK_MIN_STR
		.dc.b ARG_POP
		.dc.b TOK_MAX
		.dc.b ARG_REPLACE,TOK_MAX_STR
		.dc.b ARG_END
x15068:
